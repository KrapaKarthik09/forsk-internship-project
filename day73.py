...
scrappedReviews=None #declaring in global namespace so that it can linked when used inside the function
pickle_model=None
vocab=None
chart_dropdown_values=None
# Defining Functions
def load_model():
    ...
    cloud = WordCloud(width = 800, height = 400,
                      ...
                      stopwords = stopwords,
                      min_font_size = 12).generate(str1)
...
def update_app_ui(n_clicks, textarea_value):
    ...
    print("Value is = ", str(textarea_value))
...
def main():
    print("@Author: Karthik Krapa Project: Forsk Internship Project")
    load_model()
    open_browser()
    #update_app_ui()
